...
/** Defines a pair generator.
  ...
  * @tparam P Specifies the type of parameters in the parameter space, must be a subtype of [[lanag.core.Parameters]].
  * @tparam I Specifies the type of intention the agents generated use, must be a subtype of [[lanag.core.Intention]].
  * @tparam S Specifies the type of signal the agents generated use, must be a subtype of [[lanag.core.Signal]].
  * @tparam A Specifies the type agents generated, must be a subtype of [[lanag.core.Agent]].
  * @tparam D Specifies the data generated, must be a subtype of [[lanag.core.Data]].
...
abstract class PairGenerator[P <: Parameters, I <: Intention, S <: Signal, A <: Agent[I, S], D <: Data](sampleSize: Int) extends Serializable {
  ...
  /** Generates a pair of agents randomly, given the parameters.
    ...
    *         and [[lanag.core.Data]] reflecting the pair's origin parameters.
    */
