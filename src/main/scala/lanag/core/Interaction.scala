...
/** Defines agent interactions.
  ...
  * @tparam I The intention type used by the agents, must be a subtype of [[lanag.core.Intention]].
  * @tparam S The signal type used by the agents, must be a subtype of [[lanag.core.Signal]].
  * @tparam A The type of agents, must be a subtype of [[lanag.core.Agent]].
